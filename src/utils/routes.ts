...
// Main
const MainIndex = lazy(
  () => import("../components/layout/dashboard/main-page/index")
);
const Category = lazy(
  () => import("../components/layout/dashboard/main-page/Category")
);
const Post = lazy(
  () => import("../components/layout/dashboard/main-page/Post")
);
